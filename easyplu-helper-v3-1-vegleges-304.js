// ==UserScript==
// @name         EasyPLU Helper – v3.1 VÉGLEGES (288 termék)
// @namespace    https://easy-plu.knowledge-hero.com/
// @version      3.1.0
// @description  Gyors PLU autokitöltő - 288 termék - Teljes adatbázis!
...
/* ═══════════════════════════════════════════════════════════════════════════
📦 PLU ADATBÁZIS - 288 TERMÉK (Frissítve: 2025.01.27)
═══════════════════════════════════════════════════════════════════════════ */
...
// ÚJ - hiányzó termékek (képek alapján)
...
/* ═══════════════════════════════════════════════════════════════════════════
🍐 PACKHAMS SPECIÁLIS FELISMERÉS
═══════════════════════════════════════════════════════════════════════════ */

function findPackhamsImageId(container) {
let bestId = null;
...
for (const el of nodes) {
  ...
  const hasA = url.includes(PACKHAMS.imageA);
  const hasB = url.includes(PACKHAMS.imageB);
  ...
  const id = hasB ? PACKHAMS.imageB : PACKHAMS.imageA;
...
if (name === PACKHAMS.name) {
  const imageId = findPackhamsImageId(card);
  if (!imageId) {
